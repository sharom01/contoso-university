...
<br>These are steps to remove a file from repository commit history using <a href="https://rtyley.github.io/bfg-repo-cleaner">BFG Repo-Cleaner</a>. In this example the file name is Web.Aaa.config (note possible case sensitivity). Prerequisites: BFG Repo-Cleaner, Git and Java installed on local pc.
